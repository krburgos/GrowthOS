 ...
 * nudge for the Growth Solution Questionnaire. Originally disappeared
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="text-body font-semibold">
          {complete ? "Growth Solution Questionnaire complete" : "Complete your Growth Solution Questionnaire"}
        </p>
