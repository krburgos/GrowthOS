...
| C3 | GOS Dashboard | Playbook Step Detail — an Hours panel and a "What to do next" task list for every step, then SEO/GEO also get tabbed Status Report / Progress Tracker; all 14 steps show Duties + KPIs | All roles view; hours: MSP Owner/Admin + CRO Admin/Advisor edit; everything else: CRO Admin/Advisor edit |
