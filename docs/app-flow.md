...
| C2 | GOS Dashboard | GOS Dashboard (client-confirmed addition, 2026-09-16; backed by a real per-account schema per client-confirmed amendment, 2026-09-16 — Backend Schema §6.6c) — 14 GrowthOS Playbook steps as clickable cards, sits directly below Dashboard in the sidebar | All roles view; CRO Admin/Advisor edit |
| C3 | GOS Dashboard | Playbook Step Detail — SEO/GEO get a tabbed Status Report / Suggestions & Fixes / Progress Tracker; the other 12 steps show Duties + KPIs only | All roles view; CRO Admin/Advisor edit |
