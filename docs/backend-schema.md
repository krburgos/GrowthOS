...
Both retirements are deliberate departures from the source Playbook document, confirmed by the client on 2026-09-25 and recorded in App Flow §4.3a as well, so that neither is mistaken for an oversight and "restored" later.
