...
/**
 * Strategy was renamed Foundation (client-confirmed, 2026-09-24) once Company Profile joined it, matching the Command Center readiness strip's own "all three foundations".
 *
